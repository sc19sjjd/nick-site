<template>
  <div class="w-full h-full max-w-md flex flex-col bg-grey rounded-xl border-lightGrey border-0 shadow-md shadow-black">
    ...
    <div class="flex justify-end border-lightGrey border-0 border-t-0">
      <div class="border-lightGrey border-t-2 border-l-2 rounded-tl-xl px-3 py-1">
